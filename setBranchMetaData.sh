...
printf "Enter semantic, branch version: " && read -r RELEASE_VERSION
...
sed --in-place --regexp-extended \
  --expression "s/badge\/main-${SEMANTIC_VERSION_PATTERN}/badge\/main-${RELEASE_VERSION}/" \
  --expression "s/badge\/updated-${SORTABLE_DATE_PATTERN}/badge\/updated-${DATE}/" ./README.md
sed --in-place --regexp-extended \
  --expression "s/.TH GCKB 1 ${SORTABLE_DATE_PATTERN} ${SEMANTIC_VERSION_PATTERN}/.TH GCKB 1 ${DATE} ${RELEASE_VERSION}/" ./gckb.1
